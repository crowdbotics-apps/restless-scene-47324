"""
Django settings for restless_scene_47324 project.
...
ROOT_URLCONF = 'restless_scene_47324.urls'
...
WSGI_APPLICATION = 'restless_scene_47324.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "restless_scene_47324 API",
    "DESCRIPTION": "API documentation for restless_scene_47324 App",
    "VERSION": "v1",
}
